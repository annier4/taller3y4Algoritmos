...
public class Personaje {
	...
	private ArrayList<ParteCuerpo> extremidades; // arreglo de partes del cuerpo
													// del muñeco
	...
	public Personaje(PApplet app, int sexo) {
		...
		extremidades.add(new ParteCuerpo(app, centroX, centroY, 0, sexo)); // pierna
																			// izquierda
		extremidades.add(new ParteCuerpo(app, centroX, centroY, 1, sexo)); // brazo
																			// izquierdo
		extremidades.add(new ParteCuerpo(app, centroX, centroY, 2, sexo)); // cabeza
		extremidades.add(new ParteCuerpo(app, centroX, centroY, 3, sexo)); // brazo
																			// derecho
		extremidades.add(new ParteCuerpo(app, centroX, centroY, 4, sexo)); // pierna
																			// derecha
	...
	public void pintar() {
		...
		for (Hand hand : leap.getHands()) {
			...
			// app.stroke(0, 100);
			// dragSegment(0, dedoPulgar.getPosition().x+200,
			// dedoPulgar.getPosition().y+200);
	...
	// extremidades.get(i).pintar(dedoCorazon.getPosition().x,
	// dedoCorazon.getPosition().y);
	// break;
	...
	// extremidades.get(i).setXi(manoX+x);
	// extremidades.get(i).setYi(manoY+y);
	// extremidades.get(i).pintar(dedoAnular.getPosition().x,
	// dedoAnular.getPosition().y);
	// break;
	//
	// case 2: // cabeza
	//
	...
	// extremidades.get(i).setXi(manoX+x);
	// extremidades.get(i).setYi(manoY+y);
	// extremidades.get(i).pintar(dedoIndice.getPosition().x,
	// dedoIndice.getPosition().y);
	// break;
	...
	// extremidades.get(i).setXi(manoX+x);
	// extremidades.get(i).setYi(manoY+y);
	// extremidades.get(i).pintar(dedoMenique.getPosition().x,
	// dedoMenique.getPosition().y);
	// break;
	...
	// extremidades.get(i).setXi(manoX+x);
	// extremidades.get(i).setYi(manoY+y);
	// extremidades.get(i).pintar(dedoPulgar.getPosition().x,
	// dedoPulgar.getPosition().y);
	// break;
	//
	// }
	//
	...
	public boolean gesto(int gesto) {
		switch (gesto) {
		case 1:
			for (Hand hand : leap.getHands()) {
				PVector handPosition = hand.getPosition();
				...
				if (dif1x <= (-160.1149 + 20) && dif1x >= (-160.1149 - 20) && dif1y <= (-41.59 + 20)
						&& dif1y >= (-41.59 - 20) && dif2x <= (-137.7 + 20) && dif2x >= (-137.20 - 20)
						&& dif2y <= (13.98 + 20) && dif2y >= (13.98 - 20) && dif3x <= (-27.28 + 20)
						&& dif3x >= (-27.28 - 20) && dif3y <= (30.67 + 20) && dif3y >= (30.67 - 20)
						&& dif4x <= (53.32 + 20) && dif4x >= (53.32 - 20) && dif4y <= (22.36 + 20)
						&& dif4y >= (22.36 - 20) && dif5x <= (121.12 + 20) && dif5x >= (121.12 - 20)
						&& dif5y <= (-4.12 + 20) && dif5y >= (-4.12 - 20)) {
                         return true;
				}
		...
		case 2:
			for (Hand hand : leap.getHands()) {
				...
				if (dif1x <= (-211.29 + 20) && dif1x >= (-211.29 - 20) && dif1y <= (-95 + 20)
						&& dif1y >= (-95 - 20) && dif2x <= (-86 + 20) && dif2x >= (-86 - 20)
						&& dif2y <= (87 + 20) && dif2y >= (87 - 20) && dif3x <= (-1 + 20)
						&& dif3x >= (-1 - 20) && dif3y <= (-69 + 20) && dif3y >= (-69 - 20)
						&& dif4x <= (30 + 20) && dif4x >= (30 - 20) && dif4y <= (-65 + 20)
						&& dif4y >= (-65 - 20) && dif5x <= (35 + 20) && dif5x >= (35 - 20)
						&& dif5y <= (8 + 20) && dif5y >= (8 - 20)) {
                         return true;
				}
